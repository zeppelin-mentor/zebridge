...
import { generateQRCode } from '@/lib/tools/ai-tools'
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Execute tool
    const result = await generateQRCode(input, authContext.userId, execution.id)
    ...
    console.error('Error in generate-qrcode API:', error)
    return NextResponse.json(
